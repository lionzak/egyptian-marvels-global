  ...
  ar: [
    {
      ...
      period: 'الأسرة الثامنة عشرة',
      location: 'وادي الملوك',
      description: 'قناع جنائزي رائع مصنوع من 11 كجم من الذهب الخالص مع تطعيمات من اللازورد وغيره من الأحجار شبه الكريمة. غطى مومياء فرعون الأسرة الثامنة عشرة توت عنخ آمون. اكتشفه هوارد كارتر في عام 1922، وأصبح القناع رمزًا للحرفية المصرية القديمة وثروة الفراعنة.',
      model: '/models/tutankhamun_mask-optimized.glb',
    },
    {
      id: '2',
      name: 'حجر رشيد',
      period: 'الفترة البطلمية',
      location: 'منف',
      description: 'لوحة من الجرانوديوريت تحمل مرسومًا صدر في منف عام 196 قبل الميلاد باسم الملك بطليموس الخامس إبيفانيس. النص محفور بثلاث لغات: الهيروغليفية المصرية القديمة، الكتابة الديموطيقية، واليونانية القديمة. بفضل هذه النصوص المتوازية، أصبح من الممكن فك رموز الهيروغليفية، وهو ما أنجزه جان-فرانسوا شامبليون في عام 1822.',
      model: '/models/rosetta_stone-optimized.glb',
    },
    {
      id: '3',
      name: 'لوحة نارمر',
      period: 'الفترة السلالية المبكرة',
      location: 'هيراكونبوليس (نخن)',
      description: 'هذه اللوحة الاحتفالية المصنوعة من الأردواز الأخضر هي واحدة من أقدم وأهم الآثار في مصر القديمة. تصور الفرعون نارمر وهو يوحد مصر العليا والسفلى. الرمزية والمشاهد على اللوحة تروي قصة ولادة دولة موحدة، وتأسيس السلطة، وبداية العصر الفرعوني. من المحتمل أنها كانت تُستخدم في الطقوس وأظهرت الحق الإلهي للملك في الحكم.',
      model: '/models/narmer_palette-optimized.glb',
    },
    {
      id: '6',
      ...
      period: 'الأسرة الثامنة عشرة',
      location: 'العمرنة',
      description: 'هذا التمثال الرائع للملكة نفرتيتي، المنحوت من الحجر الجيري ومغطى بالجص والطلاء، يجسد مثال الجمال الأنثوي في مصر القديمة. وجد في ورشة النحات تحوتمس في العمرنة، يأسر التمثال بأسلوبه الراقي، تاجه الأنيق، وملامحه الوجهية التعبيرية. إنه كلحظة مجمدة — نظرة إلى الأبدية، تعكس القوة، النعمة، وغموض الملكة العظيمة.',
      model: '/models/bust_of_nefertiti-optimized.glb',
    },
    {
      id: '4',
      name: 'الأنخ — مفتاح الحياة',
      period: 'الفترة السلالية المبكرة',
      location: 'طيبة أو منف',
      description: 'في أيدي الآلهة والفراعنة، لم يكن الأنخ مجرد رمز — بل كان وعدًا. كان يُحمل في الطقوس، يُنحت على جدران المعابد, يُرتدى بالقرب من القلب. كان يهمس بالحياة الأبدية، الإحياء، والوجود اللانهائي — مفتاح مقدس للعالم المرئي وغير المرئي.',
      model: '/models/ankh-optimized.glb',
    },
  ],
};
